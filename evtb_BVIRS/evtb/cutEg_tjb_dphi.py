...
# Analysis object: /evtb/cutEg_tjb_dphi
...
exec(open(prefix+'cutEg_tjb_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjb_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjb_dphi.png'), format='PNG')
