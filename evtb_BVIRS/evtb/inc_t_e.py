...
exec(open(prefix+'inc_t_e__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_t_e.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_t_e.png'), format='PNG')
