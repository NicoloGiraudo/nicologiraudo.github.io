...
exec(open(prefix+'inc_t_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_t_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_t_pt.png'), format='PNG')
