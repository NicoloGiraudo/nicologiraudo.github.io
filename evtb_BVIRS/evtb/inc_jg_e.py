...
exec(open(prefix+'inc_jg_e__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_jg_e.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_jg_e.png'), format='PNG')
