...
exec(open(prefix+'incCutEt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'incCutEt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'incCutEt.png'), format='PNG')
