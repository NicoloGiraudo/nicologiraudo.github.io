...
# Analysis object: /evtb/inc_tjb_dphi
...
exec(open(prefix+'inc_tjb_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_tjb_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_tjb_dphi.png'), format='PNG')
