...
# Analysis object: /evtb/inc_jbjg_deta
...
exec(open(prefix+'inc_jbjg_deta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_jbjg_deta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_jbjg_deta.png'), format='PNG')
