...
exec(open(prefix+'incCutEg__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'incCutEg.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'incCutEg.png'), format='PNG')
