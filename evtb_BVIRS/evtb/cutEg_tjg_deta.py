...
# Analysis object: /evtb/cutEg_tjg_deta
...
exec(open(prefix+'cutEg_tjg_deta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjg_deta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjg_deta.png'), format='PNG')
