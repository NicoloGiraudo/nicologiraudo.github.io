...
# Analysis object: /evtb/cutEg_jg_pt
...
exec(open(prefix+'cutEg_jg_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_jg_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_jg_pt.png'), format='PNG')
