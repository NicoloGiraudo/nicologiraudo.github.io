...
# Analysis object: /evtb/cutEg_tjb_m
...
exec(open(prefix+'cutEg_tjb_m__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjb_m.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjb_m.png'), format='PNG')
