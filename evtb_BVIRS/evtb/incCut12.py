...
exec(open(prefix+'incCut12__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'incCut12.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'incCut12.png'), format='PNG')
