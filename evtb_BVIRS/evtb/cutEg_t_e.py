...
# Analysis object: /evtb/cutEg_t_e
...
exec(open(prefix+'cutEg_t_e__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_t_e.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_t_e.png'), format='PNG')
