...
# Analysis object: /evtb/cutEg_tjg_dr
...
exec(open(prefix+'cutEg_tjg_dr__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjg_dr.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjg_dr.png'), format='PNG')
