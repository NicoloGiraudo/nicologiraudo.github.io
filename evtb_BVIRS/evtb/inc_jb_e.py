...
exec(open(prefix+'inc_jb_e__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_jb_e.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_jb_e.png'), format='PNG')
