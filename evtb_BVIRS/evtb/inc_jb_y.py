...
exec(open(prefix+'inc_jb_y__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_jb_y.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_jb_y.png'), format='PNG')
