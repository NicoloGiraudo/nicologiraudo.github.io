...
# Analysis object: /evtb/cutEg_jg_e
...
exec(open(prefix+'cutEg_jg_e__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_jg_e.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_jg_e.png'), format='PNG')
