...
# Analysis object: /evtb/cutEg_t_pt
...
exec(open(prefix+'cutEg_t_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_t_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_t_pt.png'), format='PNG')
