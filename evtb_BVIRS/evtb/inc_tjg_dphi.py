...
# Analysis object: /evtb/inc_tjg_dphi
...
exec(open(prefix+'inc_tjg_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_tjg_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_tjg_dphi.png'), format='PNG')
