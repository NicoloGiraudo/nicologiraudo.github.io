...
# Analysis object: /evtb/cutEg_jbjg_deta
# Timestamp: 15-04-2024 (14:31:35)
...
labels = [ r"Sherpa BVIRS, 10M, Dalpha=0.01", r"Sherpa LO, 10M, Dalpha=0.01", r"Sherpa VIRS, 10M, Dalpha=0.01", r"OLTD, nb=10M, nq=1" ]
...
linecolors = {0: '#EE3311', 1: '#3366FF', 2: '#109618', 3: '#FF9900'}
# the numerical data is stored in a separate file
dataf = dict()
prefix = os.path.split(__file__)[0]
if prefix:    prefix = prefix + '/'
exec(open(prefix+'cutEg_jbjg_deta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_jbjg_deta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_jbjg_deta.png'), format='PNG')
