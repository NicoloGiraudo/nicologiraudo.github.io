...
# Analysis object: /evtb/cutEg_jb_pt
...
exec(open(prefix+'cutEg_jb_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_jb_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_jb_pt.png'), format='PNG')
