...
exec(open(prefix+'incCut10__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'incCut10.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'incCut10.png'), format='PNG')
