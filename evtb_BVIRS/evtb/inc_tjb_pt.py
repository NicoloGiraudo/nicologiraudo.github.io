...
# Analysis object: /evtb/inc_tjb_pt
...
exec(open(prefix+'inc_tjb_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_tjb_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_tjb_pt.png'), format='PNG')
