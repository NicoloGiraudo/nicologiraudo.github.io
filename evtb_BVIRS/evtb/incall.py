...
exec(open(prefix+'incall__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'incall.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'incall.png'), format='PNG')
