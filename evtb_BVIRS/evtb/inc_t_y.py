...
exec(open(prefix+'inc_t_y__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_t_y.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_t_y.png'), format='PNG')
