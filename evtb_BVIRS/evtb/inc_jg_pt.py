...
# Analysis object: /evtb/inc_jg_pt
...
exec(open(prefix+'inc_jg_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_jg_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_jg_pt.png'), format='PNG')
