...
exec(open(prefix+'inc__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc.png'), format='PNG')
