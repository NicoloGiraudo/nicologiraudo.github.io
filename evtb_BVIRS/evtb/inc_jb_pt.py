...
# Analysis object: /evtb/inc_jb_pt
...
exec(open(prefix+'inc_jb_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_jb_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_jb_pt.png'), format='PNG')
