...
# Analysis object: /evtb/inc_jbjg_dphi
...
exec(open(prefix+'inc_jbjg_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_jbjg_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_jbjg_dphi.png'), format='PNG')
