...
exec(open(prefix+'incCut8__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'incCut8.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'incCut8.png'), format='PNG')
