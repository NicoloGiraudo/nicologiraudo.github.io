...
exec(open(prefix+'incCut6__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'incCut6.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'incCut6.png'), format='PNG')
