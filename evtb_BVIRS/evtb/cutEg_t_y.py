...
# Analysis object: /evtb/cutEg_t_y
...
exec(open(prefix+'cutEg_t_y__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_t_y.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_t_y.png'), format='PNG')
