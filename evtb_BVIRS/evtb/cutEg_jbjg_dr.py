...
# Analysis object: /evtb/cutEg_jbjg_dr
...
exec(open(prefix+'cutEg_jbjg_dr__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_jbjg_dr.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_jbjg_dr.png'), format='PNG')
