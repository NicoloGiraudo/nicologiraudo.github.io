...
# Analysis object: /evtb/cutEg_jb_e
...
exec(open(prefix+'cutEg_jb_e__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_jb_e.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_jb_e.png'), format='PNG')
