...
# Analysis object: /evtb/cutEg_jb_y
...
exec(open(prefix+'cutEg_jb_y__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_jb_y.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_jb_y.png'), format='PNG')
