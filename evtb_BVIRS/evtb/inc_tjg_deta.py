...
# Analysis object: /evtb/inc_tjg_deta
...
exec(open(prefix+'inc_tjg_deta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_tjg_deta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_tjg_deta.png'), format='PNG')
