...
# Analysis object: /evtb/cutEg_tjb_pt
...
exec(open(prefix+'cutEg_tjb_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjb_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjb_pt.png'), format='PNG')
