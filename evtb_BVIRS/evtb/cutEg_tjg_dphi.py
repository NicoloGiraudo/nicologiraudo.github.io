...
# Analysis object: /evtb/cutEg_tjg_dphi
...
exec(open(prefix+'cutEg_tjg_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjg_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutEg_tjg_dphi.png'), format='PNG')
