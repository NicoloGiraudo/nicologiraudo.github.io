...
ax_xLabel = r'$p_{{\rm T}}$ [GeV]'
ax_yLabel = r'$\mathrm{d}\sigma / \mathrm{d} p_{{\rm T}}$ [pb/GeV]'
ax_title  = r'$e^+ \nu \to t \bar b$'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 7.0)
...
labels = [ r"evtb\_ol\_10M\_irsafe\_final", r"evtb\_sh\_10M\_VIRS\_dip001\_irsafe\_final" ]
