...
exec(open(prefix+'inc_j1_e__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_j1_e.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_j1_e.png'), format='PNG')
