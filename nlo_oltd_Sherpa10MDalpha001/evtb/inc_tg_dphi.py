...
# Analysis object: /evtb/inc_tg_dphi
# Timestamp: 12-04-2024 (15:33:37)
...
exec(open(prefix+'inc_tg_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_tg_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_tg_dphi.png'), format='PNG')
