...
exec(open(prefix+'inc_b_e__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_b_e.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_b_e.png'), format='PNG')
