...
# Analysis object: /evtb/inc_bg_dphi
...
exec(open(prefix+'inc_bg_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_bg_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_bg_dphi.png'), format='PNG')
