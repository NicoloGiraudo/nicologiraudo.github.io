...
exec(open(prefix+'inc_b_y__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_b_y.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_b_y.png'), format='PNG')
