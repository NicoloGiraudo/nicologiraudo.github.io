...
exec(open(prefix+'inc_tb_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_tb_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_tb_pt.png'), format='PNG')
