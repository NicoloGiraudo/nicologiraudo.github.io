...
# Analysis object: /evtb/inc_bg_deta
...
exec(open(prefix+'inc_bg_deta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_bg_deta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_bg_deta.png'), format='PNG')
