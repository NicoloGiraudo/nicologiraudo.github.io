...
# Analysis object: /evtb/inc_tg_deta
...
exec(open(prefix+'inc_tg_deta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_tg_deta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_tg_deta.png'), format='PNG')
