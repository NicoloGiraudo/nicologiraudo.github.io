...
# Analysis object: /evtb/inc_bg_dr
...
exec(open(prefix+'inc_bg_dr__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_bg_dr.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_bg_dr.png'), format='PNG')
