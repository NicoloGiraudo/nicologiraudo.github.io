...
exec(open(prefix+'inc_tb_m__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_tb_m.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_tb_m.png'), format='PNG')
