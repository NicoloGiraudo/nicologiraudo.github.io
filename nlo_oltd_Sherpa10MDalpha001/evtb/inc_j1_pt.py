...
# Analysis object: /evtb/inc_j1_pt
...
exec(open(prefix+'inc_j1_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_j1_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_j1_pt.png'), format='PNG')
