...
exec(open(prefix+'inc_b_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_b_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_b_pt.png'), format='PNG')
