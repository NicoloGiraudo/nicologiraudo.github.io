...
# Analysis object: /evtb/inc_tb_dphi
...
exec(open(prefix+'inc_tb_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_tb_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_tb_dphi.png'), format='PNG')
