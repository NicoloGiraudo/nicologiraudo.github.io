...
# Analysis object: /evtb/inc_tg_dr
...
exec(open(prefix+'inc_tg_dr__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'inc_tg_dr.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'inc_tg_dr.png'), format='PNG')
